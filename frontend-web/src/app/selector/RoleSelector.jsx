...
export default function RoleSelector() {
  ...
  return (
    <div className="sel-wrapper">
      ...
      {/* SNAP SECTION 1: Welcome Header & Categories Explorer */}
      <div className="sel-snap-section sel-container" style={{ justifyContent: 'flex-start', paddingTop: '20px' }}>
          ...
          >
            ...
            >
              ...
              <div style={{ padding: '28px', overflowY: 'auto', fontSize: '0.875rem', color: '#334155', lineHeight: '1.6', flexGrow: 1 }}>
                ...
                <h4 style={{ color: '#0f172a', fontWeight: '800', margin: '0 0 8px 0' }}>2. Buyer Protection & EmahuHolding</h4>
                <p style={{ margin: '0 0 16px 0' }}>
