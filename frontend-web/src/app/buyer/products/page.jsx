...
const INITIAL_PRODUCTS = [
  {
    id: 'prod-fallback-1',
    name: 'Emahu Smart Luxe Chrono Watch',
    brand: 'Emahu Luxury',
    ...
    isNew: true,
    onSale: true,
    sellerStore: 'Emahu Flagship',
    sellerName: 'Emahu Official'
  },
  {
    id: 'prod-fallback-2',
    name: 'SoundAura Pro ANC Wireless Headphones',
    brand: 'SoundAura',
    category: 'Electronics & Tech',
    subcategory: 'Audio',
    price: 12500,
    ...
    isNew: true,
    onSale: true,
    sellerStore: 'Audio Hub',
    sellerName: 'SoundAura Merchant'
  },
  {
    id: 'prod-fallback-3',
    name: 'Minimalist Solid Oak Wood Executive Desk',
    brand: 'Crafted Oak',
    ...
    isNew: false,
    onSale: true,
    sellerStore: 'Modern Home Decor',
    sellerName: 'Crafted Decor'
  },
  {
    id: 'prod-fallback-4',
    name: 'AuraRing Smart Health & Fitness Ring',
    brand: 'AuraTech',
    category: 'Electronics & Tech',
    ...
    isNew: true,
    onSale: true,
    sellerStore: 'Tech Life Hub',
    sellerName: 'Aura Tech Merchant'
  },
  {
    id: 'prod-fallback-5',
    name: 'Pro Performance Air Cushion Running Sneakers',
    brand: 'StridePro',
    ...
    isNew: true,
    onSale: true,
    sellerStore: 'Stride Sports',
    sellerName: 'Stride Retail'
  },
  {
    id: 'prod-fallback-6',
    name: 'Non-Stick Ceramic Induction Cookware Set',
    brand: 'Culinaria',
    ...
    rating: 4.7,
    reviews: 142,
    img: 'https://images.unsplash.com/photo-1584992236310-6edddc08acff?w=600&auto=format&fit=crop&q=80',
    stock: 30,
    status: 'in-stock',
    verified: true,
    isNew: false,
    onSale: true,
    sellerStore: 'Chef Essentials',
    sellerName: 'Culinaria Store'
  },
  {
    id: 'prod-fallback-7',
    name: 'Botanical Organic Facial Serum & Glow Oil',
    brand: 'PureBotanics',
    ...
    rating: 4.9,
    reviews: 310,
    img: 'https://images.unsplash.com/photo-1608248597263-00079e96047a?w=600&auto=format&fit=crop&q=80',
    stock: 60,
    status: 'in-stock',
    verified: true,
    isNew: true,
    onSale: true,
    sellerStore: 'Organic Beauty Bar',
    sellerName: 'Pure Botanics Ltd'
  },
  {
    id: 'prod-fallback-8',
    name: 'Premium Leather Executive Travel Duffel Bag',
    brand: 'LuxeCaravan',
    ...
    isNew: false,
    onSale: true,
    sellerStore: 'Luxe Travel Store',
    sellerName: 'LuxeCaravan Official'
  }
];
...
export default function ProductsPage() {
  ...
  // Products combined (seller DB products at top + initial catalog fallback)
  const allProductsCombined = useMemo(() => {
    if (formattedDbProducts && formattedDbProducts.length > 0) {
      // Filter out duplicates if any
      const dbIds = new Set(formattedDbProducts.map(p => String(p.id)));
      const filteredFallbacks = INITIAL_PRODUCTS.filter(p => !dbIds.has(String(p.id)));
      return [...formattedDbProducts, ...filteredFallbacks];
    }
